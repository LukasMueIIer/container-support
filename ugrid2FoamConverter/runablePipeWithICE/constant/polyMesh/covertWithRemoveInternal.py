...
uGrid = read_ugrid(os.path.join(path,"aflr3_CAPS.lb8.ugrid"))
boundarySurf = SurfReader()
boundarySurf.read_surf(os.path.join(path,"aflr3_CAPS.surf"))
boundaryTagFile = os.path.join(path,"aflr3_CAPS.mapbc")
espAflr2Foam.convertMesh(uGrid,boundarySurf,boundaryTagFile,path,cleanupInternalBoundaries=True,untaggedSinglesToBoundary=True,deepSearchUntaggedBoundaries=True)
